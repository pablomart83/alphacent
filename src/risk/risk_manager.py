...
SYMBOL_SECTOR_MAP: Dict[str, str] = {
    ...
    "FDX": "Industrials", "GE": "Industrials",
    ...
    "LULU": "Consumer", "CMG": "Consumer",
    # International
    "BABA": "Technology",
    # Semiconductors
    "TSM": "Technology", "ASML": "Technology", "ARM": "Technology",
    # Healthcare (expanded)
    "NVO": "Healthcare", "GILD": "Healthcare",
    # High-momentum growth
    "CRWD": "Technology", "SNOW": "Technology", "MELI": "Consumer",
    # Mining / Materials
    ...
    # Forex - each pair is its own "sector"

...
/**
 * SlippageTab — client-side execution quality analysis from the orders list.
 * Covers: slippage tiles, trend chart, hour×day heatmap, by-strategy bar,
 * rejection reasons, fill-time distribution, by-asset-class, worst 20.
 */

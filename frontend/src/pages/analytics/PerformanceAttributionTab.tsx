      ...
      {insufficientData ? (
        ...
        <>
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-muted-foreground font-mono">Group by:</span>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Attribution Effects by {groupBy === 'sector' ? 'Sector' : 'Asset Class'}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {data.cumulative_effects.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Cumulative Attribution Effects</CardTitle>
              </CardHeader>
              <CardContent>
                <InteractiveChart

      ...
      >
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-2">
          ...
          <TabsContent value="performance" className="space-y-3">
            ...
            {cioDashboard && (
              <div className="grid grid-cols-4 gap-px bg-[var(--color-dark-border)] border border-[var(--color-dark-border)] rounded">
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide">CAGR</div>
                ...
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide">Calmar</div>
                ...
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide">Info Ratio</div>
                ...
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide">DD Duration</div>
            ...
            {/* P&L + Streaks + Execution — 3-col grid */}
            {cioDashboard && (
              <div className="grid grid-cols-3 gap-px bg-[var(--color-dark-border)] border border-[var(--color-dark-border)] rounded">
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide mb-1.5">P&L Breakdown</div>
                ...
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide mb-1.5">Streaks</div>
                  <div className="space-y-1 text-[11px] font-mono">
                ...
                <div className="bg-[var(--color-dark-surface)] px-3 py-2">
                  <div className="text-[11px] text-gray-500 tracking-wide mb-1.5">Execution</div>
                  <div className="space-y-1 text-[11px] font-mono">
            ...
            {/* Strategy Lifecycle & Trade Quality */}
            {cioDashboard && (
              <>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  {/* Pipeline Health */}
                  <div className="text-[11px] text-gray-500 tracking-wide mb-1">Strategy Pipeline (30 days)</div>
                  <MetricGrid items={[
                    ...
                    { label: 'Conversion', value: `${cioDashboard.proposal_to_activation_rate?.toFixed(0) || 0}%` },
                    { label: 'Active Now', value: cioDashboard.active_strategy_count },
                    { label: 'Retired', value: cioDashboard.strategies_retired_30d, color: 'text-[#ef4444]' },
                    { label: 'Avg Lifespan', value: `${cioDashboard.avg_strategy_lifespan_days?.toFixed(0) || 0}d` },
                  ]} cols={6} />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                      <div className="text-[11px] text-gray-500 tracking-wide mb-2">Active Strategies</div>
                      <div className="space-y-2 text-[11px] font-mono">
                        ...
                        <div className="flex justify-between"><span className="text-gray-500">Avg P&L / Strategy</span><span className={cn((cioDashboard.avg_active_strategy_pnl || 0) >= 0 ? 'text-accent-green' : 'text-accent-red')}>{formatCurrency(cioDashboard.avg_active_strategy_pnl || 0)}</span></div>
                      </div>
                    </div>

                    <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                      <div className="text-[11px] text-gray-500 tracking-wide mb-2">Retired Strategies (30d)</div>
                      <div className="space-y-2 text-[11px] font-mono">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                      <div className="text-[11px] text-gray-500 tracking-wide mb-2">Trade Quality</div>
                      <div className="space-y-2 text-[11px] font-mono">
                        ...
                        <div className="flex justify-between border-t border-[var(--color-dark-border)] pt-2"><span className="text-gray-500">Open Positions</span><span>{cioDashboard.total_open_positions || 0}</span></div>
                        <div className="flex justify-between"><span className="text-gray-500">Win / Loss</span><span><span className="text-accent-green">{cioDashboard.open_winning || 0}</span> / <span className="text-accent-red">{cioDashboard.open_losing || 0}</span></span></div>
                        <div className="flex justify-between"><span className="text-gray-500">Open WR</span><span className={cn((cioDashboard.open_win_rate || 0) >= 50 ? 'text-accent-green' : 'text-yellow-400')}>{(cioDashboard.open_win_rate || 0).toFixed(1)}%</span></div>
                        <div className="flex justify-between border-t border-[var(--color-dark-border)] pt-2"><span className="text-gray-500 font-semibold">Combined WR</span><span className={cn('font-semibold', (cioDashboard.combined_win_rate || 0) >= 50 ? 'text-accent-green' : 'text-yellow-400')}>{(cioDashboard.combined_win_rate || 0).toFixed(1)}%</span></div>
                        <div className="flex justify-between"><span className="text-gray-500">Profit Factor</span><span className={cn((cioDashboard.profit_factor || 0) >= 1.5 ? 'text-accent-green' : (cioDashboard.profit_factor || 0) >= 1 ? 'text-yellow-400' : 'text-accent-red')}>{(cioDashboard.profit_factor || 0).toFixed(2)}</span></div>
                        <div className="flex justify-between"><span className="text-gray-500">Avg Win / Loss</span><span><span className="text-accent-green">{formatCurrency(cioDashboard.avg_win || 0)}</span> / <span className="text-accent-red">{formatCurrency(cioDashboard.avg_loss || 0)}</span></span></div>
                        <div className="flex justify-between"><span className="text-gray-500">Avg Hold Time</span><span>{(cioDashboard.avg_hold_time_hours || 0).toFixed(1)}h</span></div>
                      </div>
                    </div>

                    <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                      <div className="text-[11px] text-gray-500 tracking-wide mb-2">Position Closures</div>
                      <div className="space-y-2 text-[11px] font-mono">
                          ...
                          Object.entries(cioDashboard.closure_reasons)
                            ...
                            .map(([reason, count]) => (
                              <div key={reason} className="flex justify-between">
                                <span className="text-gray-500 capitalize">{reason.replace(/_/g, ' ')}</span>
            ...
            {cioDashboard && cioDashboard.daily_pnl_table.length > 0 && (
              <>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="overflow-x-auto max-h-[400px] overflow-y-auto rounded-md border border-[var(--color-dark-border)]">
                    <table className="w-full text-xs font-mono">
                      <thead className="sticky top-0 bg-[var(--color-dark-surface)]">
                        <tr className="border-b border-[var(--color-dark-border)]">
                          ...
                          <th className="text-right p-2 text-gray-500">Start Equity</th>
                          <th className="text-right p-2 text-gray-500">End Equity</th>
                          <th className="text-right p-2 text-gray-500">Daily P&L</th>
                          <th className="text-right p-2 text-gray-500">Daily %</th>
                          <th className="text-right p-2 text-gray-500">Cumulative</th>
                          <th className="text-right p-2 text-gray-500">Realized</th>
                          <th className="text-right p-2 text-gray-500">Unrealized</th>
                          <th className="text-right p-2 text-gray-500">Trades</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[...cioDashboard.daily_pnl_table].reverse().map((row) => (
                          <tr key={row.date} className="border-b border-[var(--color-dark-border)]/50 hover:bg-[var(--color-dark-surface)]">
                        ...
                        <table className="w-full text-xs font-mono">
                          <thead>
                            <tr>
                              ...
                              {months.map(m => <th key={m} className="p-2 text-center text-gray-500">{m}</th>)}
                              <th className="p-2 text-center text-gray-500 font-bold">Total</th>
                            </tr>
                          </thead>
                          <tbody>
                            {years.map(year => {
            ...
            {/* Win Rate Analysis */}
            <SectionLabel>Win Rate Analysis</SectionLabel>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3, delay: 0.2 }} className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Win Rate by Day of Week</div>
              ...
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Win Rate by Hour of Day</div>
                <ResponsiveContainer width="100%" height={220}>
            ...
            {perfStats?.winners_vs_losers?.winners && (
              <>
                <SectionLabel>Winners vs Losers</SectionLabel>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.3, delay: 0.25 }}>
                  <div className="grid grid-cols-2 gap-6 rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-[11px] font-mono">
                        ...
                        <div className="flex justify-between"><span className="text-gray-500">Common Sector</span><span>{perfStats.winners_vs_losers.winners.common_sector}</span></div>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 mb-3">
                      ...
                      <div className="space-y-2 text-[11px] font-mono">
                        ...
                        <div className="flex justify-between"><span className="text-gray-500">Common Sector</span><span>{perfStats.winners_vs_losers.losers.common_sector}</span></div>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            <SectionLabel>Drawdown & Returns Distribution</SectionLabel>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3, delay: 0.3 }} className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Drawdown Chart</div>
                <ResponsiveContainer width="100%" height={220}>
              ...
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Returns Distribution</div>
                <ResponsiveContainer width="100%" height={220}>
          ...
          <TabsContent value="trades" className="space-y-3">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Win/Loss Distribution</div>
              ...
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Holding Periods</div>
                <ResponsiveContainer width="100%" height={250}>
          ...
          <TabsContent value="regime" className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {regimeAnalysis?.crypto_cycle && regimeAnalysis.crypto_cycle.phase && (
                <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                  <div className="text-[11px] text-gray-500 tracking-wide mb-2">Bitcoin Halving Cycle</div>
                  <div className="space-y-3">
              ...
              {regimeAnalysis?.carry_rates && regimeAnalysis.carry_rates.carry && Object.keys(regimeAnalysis.carry_rates.carry).length > 0 && (
                <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                  <div className="text-[11px] text-gray-500 tracking-wide mb-2">Forex Carry Rates</div>
          ...
          <TabsContent value="trade-journal" className="space-y-3">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Best Performing Patterns</div>
              ...
              <div className="rounded-md border border-[var(--color-dark-border)] bg-[var(--color-dark-bg)] p-3">
                <div className="text-[11px] text-gray-500 tracking-wide mb-2">Worst Performing Patterns</div>

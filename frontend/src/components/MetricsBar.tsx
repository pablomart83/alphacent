  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">Equity</span>
      ...
      {/* Daily P&L */}
      <div className="flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">P&L</span>
      ...
      <div className="hidden md:flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">Pos</span>
      ...
      {/* Strategies */}
      <div className="hidden md:flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">Strats</span>
      ...
      {/* Regime */}
      <div className="hidden md:flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">Regime</span>
      ...
      {/* Health */}
      <div className="hidden md:flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">Health</span>
      ...
      <div className="hidden lg:flex items-center gap-1 shrink-0">
        <span className="text-[11px] text-gray-500 tracking-wide">Synced</span>
      ...
      <div className="hidden 2xl:flex items-center gap-1 ml-auto shrink-0">
        <Sep />
        <span className="text-[11px] text-gray-500 tracking-wide">Returns</span>

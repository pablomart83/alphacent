  ...
  return (
    <th
      className={cn(
        ...
        // Dense variant: matches DSL Templates table format
        '[.table-dense_&]:px-3 [.table-dense_&]:py-2 [.table-dense_&]:text-xs',
        className,
      )}
    >
      {children}
  ...
  return (
    <td
      className={cn(
        ...
        // Dense variant: matches DSL Templates table format (px-3 py-2, text-xs font-mono)
        '[.table-dense_&]:px-3 [.table-dense_&]:py-2 [.table-dense_&]:text-xs',
        className,
      )}
    >
